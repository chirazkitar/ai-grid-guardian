...
export const sectionTitles: Record<string, [string, string]> = {
  ...
  devices: ["Devices", "Room-by-room device control and smart home monitoring."],
  energy: ["Energy", "Electricity usage, solar production, and energy distribution analytics."],
...
export const navItems = [
  ...
  { id: 'devices', label: 'Devices', badge: 'Rooms' },
  { id: 'energy', label: 'Energy', badge: 'Solar' },
